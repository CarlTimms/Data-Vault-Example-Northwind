/* 
	...
	Business data vault link record tracking satellite history views
...
-- v_history_S_LRT_L_Customer_Type_Northwind

DROP VIEW IF EXISTS bv.v_history_S_LRT_L_Customer_Type_Northwind;
GO
...
-- v_history_S_LRT_L_Employee_Territory_Northwind

DROP VIEW IF EXISTS bv.v_history_S_LRT_L_Employee_Territory_Northwind;
GO
...
-- v_history_S_LRT_L_Order_Detail_Northwind

DROP VIEW IF EXISTS bv.v_history_S_LRT_L_Order_Detail_Northwind;
GO
