/*
	 ...
	 Business data vault hub record tracking satellite history views
...
-- v_history_S_HRT_H_Customer_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Customer_Northwind;
GO
...
-- v_history_S_HRT_H_Customer_Type_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Customer_Type_Northwind;
GO
...
-- v_history_S_HRT_H_Employee_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Employee_Northwind;
GO
...
-- v_history_S_HRT_H_Order_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Order_Northwind;
GO
...
-- v_history_S_HRT_H_Product_Category_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Product_Category_Northwind;
GO
...
-- v_history_S_HRT_H_Product_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Product_Northwind;
GO
...
-- v_history_S_HRT_H_Region_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Region_Northwind;
GO
...
-- v_history_S_HRT_H_Shipper_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Shipper_Northwind;
GO
...
-- v_history_S_HRT_H_Supplier_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Supplier_Northwind;
GO
...
-- v_history_S_HRT_H_Territory_Northwind

DROP VIEW IF EXISTS bv.v_history_S_HRT_H_Territory_Northwind;
GO
